...
Riverbed Cryptographic Module 3.0
...
Copyright © 2024 Riverbed Technology, LLC
...
This document defines the Non‐Proprietary Security Policy for the Riverbed Cryptographic Module 3.0 by Riverbed Technology, LLC, hereafter denoted the
...
During the manufacturing process, Riverbed Technology, LLC executes the build and installation instructions for the Module. The Module is pre‐installed
and  configured  in  supported  Riverbed  Technology,  LLC  solutions.  The  approved  mode  is  enabled  by  default.  There  are  no  additional  installation,
configuration, or usage instructions for operators intending to use the Module.
