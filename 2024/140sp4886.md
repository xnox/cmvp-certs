...
Gallagher FIPS Provider for OpenSSL 3
...
Copyright © 2024 Gallagher Group Ltd
...
This document defines the Non‐Proprietary Security Policy for the Gallagher FIPS Provider for OpenSSL 3 cryptographic module by Gallagher Group Ltd
(Gallagher), hereafter denoted the Module. The Module meets FIPS 140‐3 overall Level 1 requirements, with security levels as shown in Section 1.2. In
...
During the manufacturing process, Gallagher Group Ltd executes the build and installation instructions for the Module. The Module is pre‐installed and
configured in supported Gallagher Group Ltd solutions. The approved mode is enabled by default. There are no additional installation, configuration, or
