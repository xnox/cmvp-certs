...
This document defines the Non‐Proprietary Security Policy for the AIX FIPS Crypto Provider for OpenSSL 3 cryptographic module by IBM, hereafter denoted
the Module. The Module meets FIPS 140‐3 overall Level 1 requirements, with security levels as shown in Section 1.2. In accordance with AS02.05, ISO/IEC
...
Hardware Platform
IBM Hardware platform with Power 8 processor
IBM Hardware platform with Power 8 processor
IBM Hardware platform with Power 9 processor
IBM Hardware platform with Power 9 processor
IBM Hardware platform with Power 8 processor
IBM Hardware platform with Power 8 processor
IBM Hardware platform with Power 9 processor
IBM Hardware platform with Power 9 processor
IBM Hardware platform with Power 10 processor
IBM Hardware platform with Power 10 processor
IBM Hardware platform with Power 8 processor
IBM Hardware platform with Power 8 processor
IBM Hardware platform with Power 9 processor
...
The CMVP makes no statement as to the correct operation of the Module or the security strengths of the generated keys when so ported if the specific
...
Using the Output of a Random Bit
Generator
...
IFC‐SSC provides between 112 and
...
SP 800‐38F Section 3.1 Provisions  KTS:128, 192 or 256‐bit keys

provide between 128 and 256 bits
...
The calling application is responsible for use of a SP 800‐90B compliant entropy source outside the Module boundary providing at least 256 bits of
security strength. Entropy is supplied to the Module via callback functions. The following caveat applies per FIPS 140‐3 IG 9.3.A:
...
During the manufacturing process, IBM executes the build and installation instructions for the Module. The Module is pre‐installed and configured in
supported IBM solutions. The approved mode is enabled by default. There are no additional installation, configuration, or usage instructions for operators
