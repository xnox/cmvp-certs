...
Approved Service Indicators ........................................................................................... 36
...
The  Masimo  Cryptographic  Module  v1.0  is  a  software  library  providing  a  C  language  API1 for  use  by  Masimo
...
flight and offers cryptographic support for secure communications protocols (including TLS2 1.2/1.3).
...
ARM Cortex-A8 (ARMv7-A)  Without PAA
...
Masimo Patient SafetyNet View Station

Custom Linux OS with Linux 4.14.78
...
Custom Linux OS with Linux 4.16.7

Masimo Radius-7

Custom Linux OS using Yocto standard

Masimo iSirona Connectivity Hub
...
Masimo Uniview Media Hub

Masimo Uniview 60 Tablet

Masimo Zebra TC51-HC Phone

Custom Linux OS with Linux kernel 4.14.78

Masimo Radical-7 w/ ARM Cortex-A9 (ARMv7-A)

Custom Linux OS with Linux kernel 4.14.78

Masimo Root w/ ARM Cortex-A9 (ARMv7-A)
...
9 CMAC – Cipher-Based Message Authentication Code
...
AES-128, AES-192, AES-256  Deterministic random bit
...
21 DSA – Digital Signature Algorithm
...
28 Per FIPS 140-3 Implementation Guidance D.G, AES-CCM is an Approved key transport technique.
...
Triple-DES with CMAC

112 (KO2), 168 (KO1)

Triple-DES with HMAC
...
Key wrap/unwrap (encryption with
...
31 Per FIPS 140-3 Implementation Guidance D.G, AES with CMAC is an Approved key transport technique.
...
36 PBKDF2 – Password-based Key Derivation Function 2
...
Key unwrapping (using any approved mode)

Key unwrapping (using any approved mode with
...
39 SHAKE – Secure Hash Algorithm KECCAK
...
Key derivation functions for TLS 1.0/1.1; HKDF; KBKDF
...
RSA (non-compliant with untested functions)
...
PowerInterfaceInstrumentBoard I/OEthernetSoC w/ ARM Processing CoreRAMExternalPower SupplyModule Interface(Radical-7 Board)USBLCD PanelTouchControllerBoardTouch ScreenPlaintext DataEncrypted Data Control InputStatus OutputPhysical PerimeterBIOS – Basic Input/Output SystemCPU – Central Processing UnitSATA – Serial Advanced Technology AttachmentSCSI – Small Computer System InterfacePCI – Peripheral Component InterconnectLED – Light Emitting DiodePCIe – PCI expressHDD – Hard Disk DriveDVD – Digital Video DiscUSB – Universal Serial BusRAM – Random Access MemoryLCD – Liquid Crystal DisplayKEY:AudioSerialRadio BoardSD Card
...
PowerInterfaceInstrumentBoard I/OSoC w/ ARM Processing CoreRAMExternalPower SupplyAudioLCD PanelTouchControllerBoardTouch ScreenPlaintext DataEncrypted Data Control InputStatus OutputPhysical PerimeterBIOS – Basic Input/Output SystemCPU – Central Processing UnitSATA – Serial Advanced Technology AttachmentSCSI – Small Computer System InterfacePCI – Peripheral Component InterconnectLED – Light Emitting DiodePCIe – PCI expressHDD – Hard Disk DriveDVD – Digital Video DiscUSB – Universal Serial BusRAM – Random Access MemoryLCD – Liquid Crystal DisplayKEY:SerialRadio BoardSD Card
...
46 The module obtains entropy input from the calling application (which is outside of the cryptographic boundary) but exercises no control over the
...
o  AES ECB encrypt KAT47 (128-bit)
...
probability  requirement,  as  the mechanism  for  IV  generation  is  compliant  with  RFC 8446.  The
