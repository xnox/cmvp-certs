...
This  is  a  non-proprietary  Cryptographic  Module  Security  Policy  for  the  G&D  Cryptographic  Module  (software
version:  1.1.1s.006)  from  Guntermann  &  Drunck  GmbH  (G&D).  This  Security  Policy  describes  how  the  G&D
...
prepared as part of the Level 1 FIPS 140-3 validation of the module. The G&D Cryptographic Module is referred to
in this document as “G&D Cryptographic Module” or “module”.
...
•  The G&D website (www.gdsys.com) contains information on the full line of products and solutions from
...
G&D Cryptographic Module 1.1.1s.006
©2025 Guntermann & Drunck GmbH
...
Table 11 – SSPs ........................................................................................................................................................ 26
Table 12 – Non-Deterministic Random Number Generation Specification ............................................................ 29
Table 13 – Acronyms and Abbreviations ................................................................................................................. 36
...
Guntermann & Drunck GmbH is the leading KVM1 manufacturer for control room applications. G&D offers a broad
range  of  KVM  products  that  have  been  developed  over  their  35  years  of  experience  with  KVMs.  G&D  is
headquartered in Germany with G&D North America headquartered in California.

The  G&D  Cryptographic  Module  1.1.1s.006  is  a  cryptographic  library  embedded  in  the  G&D  KVM-over-IP
application software. The G&D Cryptographic Module 1.1.1s.006 offers symmetric encryption/decryption, digital
...
communications protocols (including SSH2 and TLS3 1.2/1.3).

The G&D Cryptographic Module is validated at the FIPS 140-3 section levels shown in Table 1.
...
The G&D Cryptographic Module is a software module with a multi-chip standalone embodiment. The module is
designed to operate within a modifiable operational environment. Additionally, the module is designed to utilize
the  AES-NI 4  extended  instruction  set  when  available  by  the  host  platform’s  CPU  for  processor  algorithm
...
The module is also vendor affirmed on the platforms listed in Table 3 for which testing was not performed:
...
VisionXS-IP  firmware  v1.4
with SecureCert

Marvell Armada A8040

ARM A72  With (AES, SHA2)

NXP i.MX8m mini

ARM A53  With (AES, SHA2)
...
NXP Freescale MPC 8308

PPC e300  Without

RemoteAccess IP series

RemoteAccess-IP
v1.3 with SecureCert
...
generated keys on these operational environments.
...
Table 4 and Table 5 above list the Approved and allowed algorithms; Table 9 provides descriptions of the Approved
services.
...
back to the Approved mode upon execution of an Approved service. Table 6 lists the non-Approved algorithms
implemented by the module; Table 10 below lists the services that constitute the non-Approved mode.
...
and the module’s ports and interfaces at the physical and logical boundaries can be found in Table 7. Note that
...
invoked. Refer to Table 8 above for a listing of the services associated with each authorized role.
...
The G&D Cryptographic Module is not delivered to end-users as a standalone offering. Rather, it is a pre-built
integrated component of G&D’s KVM-over-IP devices. G&D does not provide end-users with any mechanisms to
directly access the module, its source code, its APIs, or any information sent to/from the module. Thus, end-users
have no ability to independently load the module onto target platforms. No configuration steps are required to
be performed by end-users, and no end-user action is required to initialize the module for operation.
...
The  G&D  Cryptographic  Module  comprises  a  software  cryptographic  library  that  executes  in  a  modifiable
operational environment.
...
9.1
The module supports the keys and other SSPs listed in Table 11. Note that all SSP import and export is electronic
...
should contact Guntermann & Drunck GmbH for assistance.
...
on  a  platform  specified  in  section  2.1  or  one  where  portability  is  maintained.  G&D  does  not  provide  any
...
11.2
This  module  is  designed  to  support  G&D  applications,  and  these  applications  are  the  sole  consumers  of  the
...
However, if any irregular activity is noticed or the module is consistently reporting errors, then G&D Customer
...
will return “ExtraHop Cryptographic Module 2.0”, which correlates to the “G&D Cryptographic Module
1.1.1s.006” on the module’s FIPS 140-3 validation certificate.
