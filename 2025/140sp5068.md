...
Cloudian Inc.
63 Bovet Rd, #400 San Mateo, CA 94402
https://www.cloudian.com

© Cloudian Inc. 2025, Date 1st May 2025
...
This document defines the Security Policy for Cloudian Inc.’s Cloudian-FJA (FIPS Java API)
...
Indicating the jar represents the software release FJA 2.0.0, that it has successfully passed all its startup
tests, and that the software release is confirmed to have a HMAC of:
...
The Cloudian-FJA (FIPS Java API) Module is a software module, and, therefore, control of the
...
support@cloudian.com. A PGP public key can be provided if confidentiality is required around
the report.
